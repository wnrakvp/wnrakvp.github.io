        ...
        <div className="flex flex-col border bg-gray-100 rounded-lg m-4 gap-2">
          <div className="border-b flex ml-5 gap-2">
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-10 h-10 p-2 m-2 border bg-white rounded-md shadow-md"
            >
              <path
                strokeLinecap="round"
            ...
            <div className="flex flex-col">
              <p className="mt-auto text-gray-500 text-xs">Phone</p>
              <p className="mb-auto">(+66) 89 774 5763</p>
            </div>
          </div>
          <div className="border-b flex ml-5 gap-2">
            <svg
            ...
            <div className="flex flex-col">
              <p className="mt-auto text-gray-500 text-xs">Email</p>
              <p className="mb-auto">wnr.akvp@gmail.com</p>
            </div>
          </div>
          <div className="border-b flex ml-5 gap-2">
            <svg
            ...
            <div className="flex flex-col">
              <p className="mt-auto text-gray-500 text-xs">Location</p>
              <p className="mb-auto">Bangkok, Thailand</p>
            </div>
          </div>
          <div className="border-b flex ml-5 gap-2">
            <svg
            ...
            <div className="flex flex-col">
              <p className="mt-auto text-gray-500 text-xs">Birthday</p>
              <p className="mb-auto">14 Feb 1993</p>
            </div>
          </div>
        </div>
